...
import {
  ...
  Search, Monitor, Bug, Settings, Bell, Mail,
} from "lucide-react";
...
const S = 13; // item icon size constant
...
const SKILLS: SkillCategory[] = [
  {
    ...
    items: [
      ...
      skill("Node JS",      <SiNodedotjs size={S} />,    "#5FA04E"),
  ...
  },
  {
    ...
    items: [
      ...
      skill("ShadCN UI",      <SiShadcnui size={S} />,     "#FFFFFF"),
      ...
      skill("PWA",            <SiPwa size={S} />,          "#5A0FC8"),
    ],
  },
  {
    category: "Backend Engineering",
    headerIcon: <SiNodedotjs size={22} />,
  ...
  },
  {
    ...
    headerIcon: <SiDocker size={22} />,
    headerColor: "text-cyan-400",
    headerBg: "bg-cyan-400/10",
    items: [
      skill("AWS",             <Code2 size={S} />,             "#FF9900"),
  ...
  },
  {
    ...
    items: [
      skill("Firebase",              <IoLogoFirebase size={S} />,  "#FFA611"),
    ...
    <ul className="space-y-2" role="list">
      {category.items.map((item, si) => (
        <SkillItemRow
          key={item.label}
          item={item}
          // Stagger: card delay + item delay; capped to avoid long waits
